...
$result = SendCommandToVM $ipv4 $sshKey "cd /root && sleep 1 && dos2unix vsocket_guest_as_server_cid.sh && chmod u+x vsocket_guest_as_server_cid.sh && sleep 1 && ./vsocket_guest_as_server_cid.sh $hvServer"
if (-not $result)
{
