######################################################################################
## Description:
##   Check open-vm-tools appinfo plugin from ESXi host.
#######################################################################################
## Revision:
## v1.0.0 - ldu - 04/12/2020 - Build script for case ESX-OVT-044.
#######################################################################################
...
.Description
    <test>
        <testName>ovt_get_appinfo_host</testName>
        <testID>ESX-OVT-044</testID>
        <testScript>testscripts/ovt_get_appinfo_host.ps1</testScript>
        <RevertDefaultSnapshot>True</RevertDefaultSnapshot>
        <timeout>900</timeout>
        <testParams>
            <param>TC_COVERED=RHEL-187177</param>
        </testParams>
...
{
    $retVal = $Passed
    LogPrint "INFO: Get running appinfo from host: $res_appinfo"
}
else
{
    LogPrint "ERROR: Didnot find running appinfo from host: $res_appinfo"
}
