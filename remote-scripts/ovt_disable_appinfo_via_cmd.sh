...
##
## Description:
##   This script check disable appinfo plugin via vmware-toolbox-cmd
##
###############################################################################
##
## Revision:
...
###############################################################################
#         <test>
#             <testName>ovt_disable_appinfo_via_cmd</testName>
#             <testID>ESX-OVT-040</testID>
#             <testScript>ovt_disable_appinfo_via_cmd.sh</testScript>
#             <files>remote-scripts/ovt_disable_appinfo_via_cmd.sh</files>
#             <files>remote-scripts/utils.sh</files>
#             <testParams>
#                 <param>TC_COVERED=RHEL6-0000,RHEL-187177</param>
#             </testParams>
